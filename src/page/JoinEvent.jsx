    ...
    <div className="flex justify-end mt-[24px]">
      <div className="bg-white rounded-[16px] p-[24px]  shadow-sm w-[400px]">
        <div className="flex justify-between items-center mb-4 border border-[#E5E5E5] py-[18px] px-[16px] rounded-[16px]">
          ...
          <div>
            <span className="font-bold text-[#171717] text-[18px]">320tk</span>
        ...
        <div className="w-full bg-[#63CFA0] hover:bg-[#6fc8a1] rounded p-[16px] flex justify-center">
          <button className=" text-[#171717] p-[16px] text-[18px] font-[18px] leading-[2px] font-[700] ">
            Join event
          </button>
        </div>
      </div>

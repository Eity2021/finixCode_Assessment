...
export default function Info() {
  return (
    ...
    <div className="flex flex-wrap gap-2 my-[60px]">
      <span className="bg-blue-100  px-[24px] py-[16px] rounded-[48px] md:text-[24px] text-[18px] font-[400]  text-[#4a4a4a]">Football</span>
      <span className="bg-cyan-100  px-[24px] py-[16px] rounded-[48px] md:text-[24px] text-[18px] font-[400]  text-[#4a4a4a]">Relay</span>
      <span className="bg-pink-100  px-[24px] py-[16px] rounded-[48px] md:text-[24px] text-[18px] font-[400]  text-[#4a4a4a]">Female</span>
      <span className="bg-purple-100  px-[24px] py-[16px] rounded-[48px] md:text-[24px] text-[18px] font-[400]  text-[#4a4a4a]">Age: Below 25</span>
      <div className="flex items-center gap-2 ml-auto">
        <img src={DifficultyIcons} />
        <span className="md:text-[24px] text-[18px] font-[400] text-[#4a4a4a] leading-[40px]">Beginner</span>
      </div>
    </div>

    <section className='lg::pr-36 p-0'>
